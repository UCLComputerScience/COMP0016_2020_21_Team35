...
# module, triggering this warning.  The warning breaks DEP-8 unit_tests (because of
# the stderr output) and is just plain annoying in normal usage.  I don't want
# to add socks as yet another dependency for pip, nor do I want to allow-stder
# in the DEP-8 unit_tests, so just suppress the warning.  pdb tells me this has to
