...
from main_application.voiceflow_to_json.voiceflow_to_json import VoiceflowToJson
...
class ProjectWidget(QWidget):
    ...
    def create_ivr(self):
        ...
        voiceflow_json = VoiceflowToJson(self.workspace_name, self.project_name, self.headers)
