...
from main_application.voiceflow_to_json.voiceflow_to_json import GetVoiceflowInformation
...
class LoginWidget(QWidget):
    ...
    # Setup project page if user logs in
    def project_window(self):
        self.voiceflow_api = GetVoiceflowInformation(email=self.email.text(), password=self.password.text())
