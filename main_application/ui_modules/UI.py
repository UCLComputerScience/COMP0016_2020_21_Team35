...
from main_application.ui_modules.add_voice_files_page import AddVoiceFilesWidget
from main_application.ui_modules.choose_voiceflow_file_page import ChooseVoiceflowFileWidget
from main_application.ui_modules.home_page import HomePageWidget
from main_application.ui_modules.ivr_generator_page import IvrGeneratorWidget
from main_application.ui_modules.ivr_server_status_page import IvrServerStatusWidget
from main_application.ui_modules.login_page import LoginWidget
from main_application.ui_modules.project_page import ProjectWidget
from main_application.ui_modules.pstn_settings_page import PstnSettingsWidget
from main_application.ui_modules.redirect_settings_page import RedirectSettingsWidget
from main_application.ui_modules.statistics_page import StatsWidget
...
# Using this, icons appear on the left of a button on the UI
...
class ProgramUi(QMainWindow):
    ...
    # Setup menu and go to Home page on startup
    def initUI(self):
    ...
    # Go back to previous page and resize UI correctly
    ...
    # page UI events - button clicks, redirects etc
